  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#141414] text-white">
      ...
      <header className="py-6 px-4 text-center border-b border-gray-800">
        <h1 className="text-3xl font-bold text-white">Step 1: Select Your Programme</h1>
        <p className="text-gray-400 mt-2">Choose your university and school to get started</p>
      </header>

      {/* University Selection Section */}
      <section className="relative flex-1 min-h-[40vh]" style={{ backgroundImage: `url(${selectedUniversity.image})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="flex justify-center items-center gap-4 p-4 bg-[#141414] z-10">
        <Button 
          ...
          className="bg-[#ff0a16] text-white hover:bg-[#cc0812]"
        >
      ...
      <section className="relative flex-1 min-h-[40vh]" style={{ backgroundImage: `url(${selectedSchool.image})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div style={pixelsOverlay}></div>
        <div style={gradientOverlay}></div>
